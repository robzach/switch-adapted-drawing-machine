...
*/
  ...
  setXY(originX, originY);  // lower after arriving at first point
  lift(0);

  // draw all sides of square
  setXY(originX, originY + sideLength);
  setXY(originX + sideLength, originY + sideLength);
  setXY(originX + sideLength, originY);
